...
public class FreemarkerUtils {
    ...
    public static Template getTemplate(String ftlName) throws Exception {
        try {
            ...
            InputStream resourceAsStream = FreemarkerUtils.class.getClassLoader().getResourceAsStream(ftlName);
            stringLoader.putTemplate(ftlName, IOUtils.toString(resourceAsStream));
